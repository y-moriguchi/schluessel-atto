	...
	int lexer_step(int $c) {
		...
		case 14:
			if(($c >= '0' && $c <= '9')) {
				STATE = 14;
				return 1;
			} else if(($c >= 0 && $c <= 8) || ($c >= 11 && $c <= 31) || ($c == '!') || ($c >= '$' && $c <= '&') || ($c >= '*' && $c <= '+') || ($c >= '-' && $c <= '/') || ($c == ':') || ($c >= '<' && $c <= 'D') || ($c >= 'F' && $c <= ']') || ($c == '_') || ($c >= 'a' && $c <= 'd') || ($c >= 'f' && $c <= 2147483647)) {
				STATE = 8;
				return 1;
			} else if(($c == 'E') || ($c == 'e')) {
				STATE = 15;
		...
		case 19:
			...
			return 0;
		case 28:
			if(($c >= 0 && $c <= 8) || ($c >= 11 && $c <= 31) || ($c == '!') || ($c >= '$' && $c <= '&') || ($c >= '*' && $c <= '+') || ($c >= '-' && $c <= ':') || ($c >= '<' && $c <= '@') || ($c >= '[' && $c <= ']') || ($c == '_') || ($c >= '{' && $c <= 2147483647)) {
				STATE = 20;
				return 1;
			} else if(($c >= 'A' && $c <= 'Z') || ($c >= 'a' && $c <= 'z')) {
				STATE = 29;
...
return (false || STATE == 9 || STATE == 11 || STATE == 26 || STATE == 35 || STATE == 32 || STATE == 23);
	}
