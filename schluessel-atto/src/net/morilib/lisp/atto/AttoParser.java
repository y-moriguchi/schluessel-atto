	...
	int lexer_step(int $c) {
		...
		case 20:
			if(($c >= 9 && $c <= '\n') || ($c == ' ') || ($c >= '"' && $c <= '#') || ($c >= '\'' && $c <= ')') || ($c == ',') || ($c == ';') || ($c == '^') || ($c == '`')) {
				...
				STATE = 21;
				return 1;
			} else if(($c >= 0 && $c <= 8) || ($c >= 11 && $c <= 31) || ($c == '!') || ($c >= '$' && $c <= '&') || ($c >= '*' && $c <= '+') || ($c >= '-' && $c <= '.') || ($c >= '0' && $c <= ':') || ($c >= '<' && $c <= '[') || ($c == ']') || ($c == '_') || ($c >= 'a' && $c <= 2147483647)) {
				STATE = 20;
				return 1;
			} else if(($c == '\\')) {
				STATE = 22;
		...
		case 23:
			if(($c >= 9 && $c <= '\n') || ($c == ' ') || ($c >= '"' && $c <= '#') || ($c >= '\'' && $c <= ')') || ($c == ',') || ($c == ';') || ($c == '^') || ($c == '`')) {
				...
				STATE = 21;
				return 1;
			} else if(($c >= 0 && $c <= 8) || ($c >= 11 && $c <= 31) || ($c == '!') || ($c >= '$' && $c <= '&') || ($c >= '*' && $c <= '+') || ($c >= '-' && $c <= '.') || ($c >= '0' && $c <= ':') || ($c >= '<' && $c <= '[') || ($c == ']') || ($c == '_') || ($c >= '{' && $c <= 2147483647)) {
				STATE = 20;
				return 1;
			} else if(($c >= 'a' && $c <= 'z')) {
				STATE = 23;
		...
		case 24:
			...
			return 0;
		case 17:
			if(($c >= 0 && $c <= 8) || ($c >= 11 && $c <= 31) || ($c == '!') || ($c >= '$' && $c <= '&') || ($c >= '*' && $c <= '+') || ($c >= '-' && $c <= '/') || ($c >= '8' && $c <= ':') || ($c >= '<' && $c <= ']') || ($c == '_') || ($c >= 'a' && $c <= 2147483647)) {
				STATE = 15;
				return 1;
			} else if(($c >= '0' && $c <= '7')) {
				STATE = 27;
		...
		case 15:
			...
			return 0;
		case 14:
			if(($c >= 0 && $c <= 8) || ($c >= 11 && $c <= 31) || ($c == '!') || ($c >= '$' && $c <= '&') || ($c >= '*' && $c <= '+') || ($c >= '-' && $c <= '/') || ($c >= '2' && $c <= ':') || ($c >= '<' && $c <= ']') || ($c == '_') || ($c >= 'a' && $c <= 2147483647)) {
				STATE = 15;
				return 1;
			} else if(($c >= '0' && $c <= '1')) {
				STATE = 28;
		...
		case 28:
			...
			return 0;
		case 13:
			if(($c >= 0 && $c <= 8) || ($c >= 11 && $c <= 31) || ($c == '!') || ($c >= '$' && $c <= '&') || ($c >= '*' && $c <= '+') || ($c >= '-' && $c <= '/') || ($c == ':') || ($c >= '<' && $c <= '@') || ($c >= 'G' && $c <= ']') || ($c == '_') || ($c >= 'g' && $c <= 2147483647)) {
				STATE = 15;
				return 1;
		...
		case 48:
			...
			return 0;
		case 35:
			if(($c >= 0 && $c <= 8) || ($c >= 11 && $c <= 31) || ($c == '!') || ($c >= '$' && $c <= '&') || ($c == '*') || ($c == '/') || ($c == ':') || ($c >= '<' && $c <= 'D') || ($c >= 'F' && $c <= ']') || ($c == '_') || ($c >= 'a' && $c <= 'd') || ($c >= 'f' && $c <= 'h') || ($c >= 'j' && $c <= 2147483647)) {
				STATE = 5;
				return 1;
			} else if(($c >= '0' && $c <= '9')) {
				STATE = 35;
...
return (false || STATE == 34 || STATE == 9 || STATE == 10 || STATE == 16 || STATE == 51 || STATE == 30);
	}
