...
SExpression.ENGINE_exp.step = function($this, __rd,  $c)  {
	...
	case 0:
		if($c !== null && ((__l__ && $c === 35))) {
			...
			$this.__stkpush(7, $this.ENGINE_value);
			$this.__state = 0;
			return -1;
		}
		return 0;
	...
	case 5:
		if($c !== null && (($c >= 9 && $c <= 10) || ($c === 32))) {
			...
			$this.__stkpush(8, $this.ENGINE_exp);
			$this.__state = 0;
			return -1;
		}
		return 0;
	...
	case 3:
		if($c !== null && (($c === 41))) {
			...
			$this.__stkpush(10, $this.ENGINE_exp);
			$this.__state = 0;
			return -1;
		}
		return 0;
	...
	case 16:
		if($c !== null) {
			$this.__stkpush(18, $this.ENGINE_exp);
			$this.__state = 0;
			return -1;
		}
		return 0;
	...
	case 21:
		if($c !== null && (($c >= 9 && $c <= 10) || ($c === 32))) {
			...
			$this.__stkpush(23, $this.ENGINE_exp);
			$this.__state = 0;
			return -1;
		}
		return 0;
...
SExpression.ENGINE_value.step = function($this, __rd,  $c)  {
	...
	case 6:
		if($c !== null && (($c === 79) || ($c === 111))) {
			...
			$this.__state = 15;
			return 1;
			} else if($c !== null && (($c === 0) || ($c >= 2 && $c <= 8) || ($c >= 11 && $c <= 31) || ($c === 33) || ($c >= 36 && $c <= 38) || ($c >= 42 && $c <= 43) || ($c >= 45 && $c <= 46) || ($c >= 48 && $c <= 58) || ($c >= 60 && $c <= 65) || ($c >= 67 && $c <= 78) || ($c >= 80 && $c <= 87) || ($c >= 89 && $c <= 91) || ($c === 93) || ($c === 95) || ($c === 97) || ($c >= 99 && $c <= 110) || ($c >= 112 && $c <= 119) || ($c >= 121 && $c <= 2147483647))) {
			$this.__state = 16;
			return 1;
			} else if($c !== null && (($c === 47))) {
			$this.__state = 17;
	...
	case 17:
		if($c !== null && (($c === 92))) {
			...
			return 1;
				...
				$this.re = $this.buf;$this.clearbuf()
			$this.__state = 19;
			return 1;
		} else if($c !== null) {
			$this.addbuf($c);
